...
COIN_TX='cryptosaga-tx'
COIN_PATH='/usr/local/bin/'
OS_VERSION=$(lsb_release -d)
COIN_TGZP='https://github.com/cryptosagacoin/SAGA/releases/download/v4.0.2.1/SAGA-4.0.2.1-Linux.zip'
COIN_BOOTSTRAP='https://explorer.decenomy.net/bootstraps/SAGA/bootstrap.zip'
COIN_BOOTSTRAP_NAME=$(echo $COIN_BOOTSTRAP | awk -F'/' '{print $NF}')
COIN_TGZ=$(echo $COIN_TGZP | awk -F'/' '{print $NF}')
COIN_NAME='cryptosaga'
COIN_NAME_OLD='cryptosagad'
PROJECT_NAME='CryptoSaga (SAGA)'
COIN_EXPLORER='https://explorer.decenomy.net/SAGA/blocks'
COIN_PORT=37552
RPC_PORT=37553
...
cat << EOF > /root/cryptosaga-general-info
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
echo -e "${GREEN}$PROJECT_NAME General Info: ${NC}"
$COIN_CLI getinfo
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/cryptosaga-general-info

cat << EOF > /root/cryptosaga-fee-info
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
echo -e "${GREEN}$PROJECT_NAME Fee Info: ${NC}"
$COIN_CLI getfeeinfo 100
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/cryptosaga-fee-info

cat << EOF > /root/cryptosaga-networkinfo
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
echo -e "${GREEN}$PROJECT_NAME Network Info: ${NC}"
$COIN_CLI getnetworkinfo
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/cryptosaga-networkinfo

cat << EOF > /root/cryptosaga-masternode-stats
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
...
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/cryptosaga-masternode-stats

cp /root/.bashrc /root/.bashrc.backup
sed '/feestats/d' /root/.bashrc | sed '/networkstats/d' | sed '/mnstats/d' | sed '/cryptosagainfo/d' > /root/tmp
mv /root/tmp /root/.bashrc
echo -e "alias feestats='/root/cryptosaga-fee-info'" >> /root/.bashrc
echo -e "alias networkstats='/root/cryptosaga-networkinfo'" >> /root/.bashrc
echo -e "alias mnstats='/root/cryptosaga-masternode-stats'" >> /root/.bashrc
exec bash
}
...
function important_information() {
 ...
 echo -e "You can also use ${RED}$COIN_CLI getinfo${NC}, ${RED}$COIN_CLI getblockcount${NC}, ${RED}$COIN_CLI getmasternodewinners${NC} and ${RED}$COIN_CLI getblockchaininfo${NC} commands for a nice looking infos.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
